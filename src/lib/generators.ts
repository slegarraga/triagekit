...
export function generateMarkdown(f: FormState): string {
...
export function generateConfig(f: FormState): string {
...
export function generateChecklist(f: FormState): string {
  const repo = f.projectName || 'your-project'
